...
var register$g = {
	...
	furtherRegistration: "Pokračovat",
	...
	postRegisterSuccessMessage: "Váš účet byl úspěšně vytvořen! Přihlaste se pomocí poskytnutých přihlašovacích údajů",
	rateLimitForRegistrationMessage: "Dosáhli jste limitu pro odeslání ověřovacího kódu. Před dalším pokusem vyčkejte {{seconds}} sekund nebo použijte jinou e-mailovou adresu.",
	verificationTokenForm: {
		createVerificationToken: "Ověřovací kód zaslán na {{target}}. Zadejte kód.",
		sendRateLime: "za {{waitTime}} s",
...
var register$f = {
	...
	postRegisterSuccessMessage: "Ihr Konto wurde erfolgreich erstellt! Mit bereitgestellten Anmeldedaten anmelden",
	rateLimitForRegistrationMessage: "Sie haben das Limit für das Senden des Verifizierungscodes erreicht. Warten Sie {{seconds}} Sekunden, bevor Sie es erneut versuchen, oder verwenden Sie eine andere E-Mail-Adresse.",
	verificationTokenForm: {
		createVerificationToken: "Verifizierungscode wurde an {{target}} gesendet. Geben Sie den Code ein.",
...
var register$d = {
	...
	postRegisterSuccessMessage: "Su cuenta se ha creado correctamente. Inicie sesión con las credenciales provistas",
	rateLimitForRegistrationMessage: "Ha alcanzado el límite de envíos de código de verificación. Espere {{seconds}} segundos antes de volver a intentar o utilice otra dirección de correo electrónico.",
	verificationTokenForm: {
		createVerificationToken: "El código de verificación se ha enviado a {{target}}. Introduzca el código.",
...
var register$c = {
	...
	postRegisterMessage: "Inicie sesión con las credenciales provistas.",
	postRegisterSuccessMessage: "Su cuenta se creó correctamente. Inicie sesión con las credenciales provistas",
	rateLimitForRegistrationMessage: "Alcanzó el límite de envíos de código de verificación. Espere {{seconds}} segundos antes de volver a intentar o use otra dirección de correo electrónico.",
	verificationTokenForm: {
		createVerificationToken: "El código de verificación se envió a {{target}}. Ingrese el código.",
		sendRateLime: "En {{waitTime}} segundos",
		resend: "Reenviar",
		verificationCode: {
			label: "Código de verificación",
...
var register$b = {
	...
	register: "S'inscrire",
	furtherRegistration: "Poursuivre",
	...
	postRegisterSuccessMessage: "Votre compte a été correctement créé ! Connectez-vous à l'aide des identifiants fournis.",
	rateLimitForRegistrationMessage: "Vous avez atteint la limite d'envoi du code de vérification. Patientez {{seconds}} secondes avant de réessayer. Vous pouvez également utiliser une autre adresse e-mail.",
	verificationTokenForm: {
		createVerificationToken: "Un code de vérification a été envoyé à {{target}}. Veuillez saisir le code.",
...
var register$a = {
	...
	postRegisterSuccessMessage: "आपका खाता सफलतापूर्वक बनाया गया! कृपया प्रदत्त क्रेडेंशियल के साथ लॉग इन करें",
	rateLimitForRegistrationMessage: "आपने सत्यापन कोड भेजने की सीमा प्राप्त कर ली है. पुनः कोशिश करने के लिए कृपया {{seconds}} सेकंड प्रतीक्षा करें या अलग ईमेल पते का उपयोग करें.",
	verificationTokenForm: {
		createVerificationToken: "{{target}} को सत्यापन कोड भेजा गया. कृपया कोड दर्ज करें.",
...
var register$9 = {
	...
	postRegisterSuccessMessage: "Fiókja sikeresen létrejött! Jelentkezzen be a megadott azonosító adatokkal",
	rateLimitForRegistrationMessage: "Elérte az ellenőrző kód küldésének korlátját. Várjon {{seconds}} másodpercet, mielőtt újrapróbálkozna, vagy használjon egy másik e-mail-címet.",
	verificationTokenForm: {
		createVerificationToken: "Ellenőrző kód elküldve a következő címre: {{target}}. Adja meg a kódot.",
...
var register$8 = {
	...
	postRegisterSuccessMessage: "Akun Anda telah berhasil dibuat! Silakan masuk menggunakan kredensial yang diberikan",
	rateLimitForRegistrationMessage: "Batas pengiriman kode verifikasi telah mencapai batas maksimum. Harap tunggu selama {{seconds}} detik sebelum mencoba lagi atau gunakan alamat email yang lain.",
	verificationTokenForm: {
		createVerificationToken: "Kode verifikasi telah dikirimkan ke {{target}}. Silakan masukkan kode tersebut.",
...
var register$7 = {
	...
	postRegisterSuccessMessage: "L'account è stato creato correttamente. Accedere con le credenziali fornite",
	rateLimitForRegistrationMessage: "È stato raggiunto il limite per l'invio del codice di verifica. Attendere {{seconds}} secondi prima di riprovare o utilizzare un indirizzo e-mail diverso.",
	verificationTokenForm: {
		createVerificationToken: "Il codice di verifica è stato inviato a {{target}}. Inserire il codice.",
...
var register$6 = {
	...
	postRegisterSuccessMessage: "アカウントが正常に作成されました。指定された認証情報を使用してログインしてください",
	rateLimitForRegistrationMessage: "認証コード送信の制限に達しました。{{seconds}} 秒間待機してからもう一度実行するか、または別の電子メールアドレスを使用してください。",
	verificationTokenForm: {
		createVerificationToken: "認証コードが {{target}} に送信されました。コードを入力してください。",
...
var register$5 = {
	...
	postRegisterSuccessMessage: "계정이 생성되었습니다. 제공된 자격 증명으로 로그인하십시오. ",
	rateLimitForRegistrationMessage: "인증 코드 전송 한도에 도달했습니다. {{seconds}}초 후에 다시 시도하거나 다른 이메일 주소를 사용하십시오.",
	verificationTokenForm: {
		createVerificationToken: "{{target}}에 인증 코드를 보냈습니다. 코드를 입력하십시오.",
...
var register$4 = {
	...
	postRegisterSuccessMessage: "Konto zostało utworzone. Zaloguj się przy użyciu otrzymanych danych.",
	rateLimitForRegistrationMessage: "Osiągnięto limit wysyłania kodu weryfikacyjnego. Spróbuj ponownie za {{seconds}} sekund(y) lub skorzystaj z innego adresu e-mail.",
	verificationTokenForm: {
		createVerificationToken: "Kod weryfikacyjny został wysłany do {{target}}. Proszę wprowadź kod.",
...
var register$3 = {
	...
	postRegisterSuccessMessage: "Sua conta foi criada com êxito! Faça o login com as credenciais fornecidas.",
	rateLimitForRegistrationMessage: "Você alcançou o limite de envio do código de verificação. Aguarde {{seconds}} segundos antes de tentar novamente ou utilize um endereço de e-mail diferente.",
	verificationTokenForm: {
		createVerificationToken: "Código de verificação enviado para {{target}}. Insira o código.",
...
var register$2 = {
	...
	furtherRegistration: "Продолжить",
	...
	postRegisterSuccessMessage: "Ваша учетная запись создана. Войдите в систему с предоставленными учетными данными.",
	rateLimitForRegistrationMessage: "Достигнут лимит отправки кодов верификации. Подождите {{seconds}} сек. и повторите попытку или используйте другой адрес электронной почты.",
	verificationTokenForm: {
		createVerificationToken: "Код верификации отправлен на {{target}}. Введите код.",
...
var register$1 = {
	...
	postRegisterSuccessMessage: "您的帐户已成功创建！请使用提供的凭据登录",
	rateLimitForRegistrationMessage: "您已达到发送验证码的次数限制。请等候 {{seconds}} 秒，然后重新尝试或使用其他电子邮件地址。",
	verificationTokenForm: {
		createVerificationToken: "验证码已发送至 {{target}}。请输入验证码。",
...
var register = {
	...
	postRegisterSuccessMessage: "您的帳戶已成功建立！請使用提供的憑證登入",
	rateLimitForRegistrationMessage: "您已達到傳送驗證代碼的限制。請稍候 {{seconds}} 秒再重試，或使用不同的電子郵件地址。",
	verificationTokenForm: {
		createVerificationToken: "驗證代碼已傳送至 {{target}}，請輸入代碼。",
...
export { userProfileTranslationChunksConfig, cs as userProfileTranslationsCs, de as userProfileTranslationsDe, en as userProfileTranslationsEn, es as userProfileTranslationsEs, es_CO as userProfileTranslationsEs_CO, fr as userProfileTranslationsFr, hi as userProfileTranslationsHi, hu as userProfileTranslationsHu, id as userProfileTranslationsId, it as userProfileTranslationsIt, ja as userProfileTranslationsJa, ko as userProfileTranslationsKo, pl as userProfileTranslationsPl, pt as userProfileTranslationsPt, ru as userProfileTranslationsRu, zh as userProfileTranslationsZh, zh_TW as userProfileTranslationsZh_TW };
