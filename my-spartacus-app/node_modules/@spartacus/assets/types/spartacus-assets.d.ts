    ...
    common: {
        ...
        formErrors: {
            labeled: {
                ...
                cxContainsSpecialCharacters: string;
                cxNoConsecutiveCharacters: string;
                cxMustEndWithLegalCharacter: string;
                invalidTokenCodeError: string;
                date: {
                    required: string;
                    min: string;
        ...
        assistiveMessage: {
            actionCancelled: string;
            dropdownItemCount: string;
            dropdownItemCount_other: string;
        };
        passwordVisibility: {
            showPassword: string;
            hidePassword: string;
...
declare const translationChunksConfig: {
    common: string[];
    deliveryMode: string[];
...
export type { TranslationChunksConfig };
