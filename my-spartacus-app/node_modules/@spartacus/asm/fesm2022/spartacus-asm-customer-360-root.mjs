...
import { PageComponentModule, LAUNCH_CALLER } from '@spartacus/storefront';
...
class SiteContextInterceptor {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SiteContextInterceptor, deps: [{ token: i1.LanguageService }, { token: i1.CurrencyService }, { token: i1.OccEndpointsService }, { token: i1.SiteContextConfig }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SiteContextInterceptor, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SiteContextInterceptor, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: () => [{ type: i1.LanguageService }, { type: i1.CurrencyService }, { type: i1.OccEndpointsService }, { type: i1.SiteContextConfig }] });
...
class AsmCustomer360RootModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360RootModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360RootModule, imports: [PageComponentModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360RootModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360RootModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [PageComponentModule],
                    providers: [
...
class AsmCustomer360Facade {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Facade, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Facade, providedIn: 'root', useFactory: () => facadeFactory({
            facade: AsmCustomer360Facade,
            feature: ASM_CUSTOMER_360_FEATURE,
            methods: ['get360Data'],
        }) }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Facade, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
