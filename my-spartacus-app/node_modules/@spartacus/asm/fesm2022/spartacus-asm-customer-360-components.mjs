import { NgComponentOutlet, NgTemplateOutlet, NgIf, NgFor, AsyncPipe, CommonModule, NgClass } from '@angular/common';
import * as i0 from '@angular/core';
import { Injectable, EventEmitter, Output, Input, Component, ViewChildren, HostBinding, ChangeDetectionStrategy, NgModule, ViewChild } from '@angular/core';
import { ArgsPipe, SortOrder, itemsWith, property, byNullish, whenType, isString, byString, isNumber, byComparison, isBoolean, byBoolean, ArgsModule } from '@spartacus/asm/core';
import * as i3$1 from '@spartacus/core';
import { Config, GlobalMessageType, isNotUndefined, TranslatePipe, CxDatePipe, I18nModule, ProductScope, provideDefaultConfig } from '@spartacus/core';
import * as i3 from '@spartacus/storefront';
import { ICON_TYPE, DirectionMode, FocusDirective, MessageComponent, MediaComponent, IconComponent, LAUNCH_CALLER, DIALOG_TYPE, MediaModule, BREAKPOINT, StarRatingComponent, StarRatingModule, MessageComponentModule, IconModule, SearchBoxModule, CardComponent, CardModule, KeyboardFocusModule, PageComponentModule } from '@spartacus/storefront';
...
import * as i2$1 from '@spartacus/cart/base/root';
import * as i2$2 from '@spartacus/storefinder/core';
...
class AsmCustomer360SectionContext {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContext, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContext }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContext, decorators: [{
            type: Injectable
        }] });
...
class AsmCustomer360SectionContextSource extends AsmCustomer360SectionContext {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContextSource, deps: null, target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContextSource }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionContextSource, decorators: [{
            type: Injectable
        }] });
...
class AsmCustomer360SectionComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionComponent, deps: [{ token: AsmCustomer360SectionContextSource }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360SectionComponent, isStandalone: true, selector: "cx-asm-customer-360-section", inputs: { component: "component", customer: "customer", config: "config", data: "data" }, outputs: { navigate: "navigate" }, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SectionComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-asm-customer-360-section', providers: [
                    ...
                    ], imports: [NgComponentOutlet], template: "<ng-container *ngComponentOutlet=\"component\"></ng-container>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContextSource }], propDecorators: { component: [{
                type: Input
            }], customer: [{
                type: Input
            }], config: [{
...
class AsmCustomer360Config {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Config, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Config, providedIn: 'root', useExisting: Config }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Config, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                    useExisting: Config,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360Component, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AsmCustomer360Config }, { type: i2.AsmCustomer360Facade }, { type: i3.LaunchDialogService }, { type: i4.CsAgentAuthService }, { type: i3.DirectionService }], propDecorators: { role: [{
                type: HostBinding,
                args: ['attr.role']
            }], modal: [{
                type: HostBinding,
...
class AsmCustomer360ProductItemComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360ProductItemComponent, isStandalone: true, selector: "cx-asm-customer-360-product-item", inputs: { product: "product", quantity: "quantity", isOrderEntry: "isOrderEntry" }, outputs: { selectProduct: "selectProduct" }, ngImport: i0, template: "<button\n  class=\"cx-asm-customer-360-product-item-media link\"\n  [attr.aria-label]=\"product?.name\"\n  (click)=\"selectProduct.emit(product)\"\n>\n  <cx-media\n    [container]=\"product?.images?.PRIMARY\"\n    format=\"product\"\n    [alt]=\"product?.name ?? ''\"\n  ></cx-media>\n</button>\n<div class=\"cx-asm-customer-360-product-item-content\">\n  <button\n    [attr.aria-label]=\"product?.name\"\n    (click)=\"selectProduct.emit(product)\"\n    class=\"cx-asm-customer-360-product-item-name link\"\n  >\n    <span title=\"{{ product?.name }}\">{{ product?.name }}</span>\n  </button>\n  <ng-container *ngIf=\"isOrderEntry; else notOrderEntryTemplate\">\n    <div class=\"cx-asm-customer-360-product-item-code\">\n      {{ product?.code }}\n    </div>\n    <div class=\"cx-asm-customer-360-product-item-quantity\" *ngIf=\"quantity\">\n      {{\n        'asmCustomer360.productItem.quantity' | cxTranslate: { count: quantity }\n      }}\n    </div>\n    <div class=\"cx-asm-customer-360-product-item-price\">\n      {{\n        'asmCustomer360.productItem.itemPrice'\n          | cxTranslate\n            : { price: product?.basePrice ?? product?.price?.formattedValue }\n      }}\n    </div>\n  </ng-container>\n  <ng-template #notOrderEntryTemplate>\n    <div\n      class=\"cx-asm-customer-360-product-item-out-of-stock\"\n      *ngIf=\"product.stock?.stockLevelStatus === 'outOfStock'\"\n    >\n      {{ 'asmCustomer360.productItem.outOfStock' | cxTranslate }}\n    </div>\n  </ng-template>\n</div>\n", dependencies: [{ kind: "component", type: MediaComponent, selector: "cx-media", inputs: ["container", "format", "alt", "role", "loading", "fetchPriority", "elementType", "sizesForImgElement"], outputs: ["loaded"] }, { kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-asm-customer-360-product-item', changeDetection: ChangeDetectionStrategy.OnPush, imports: [MediaComponent, NgIf, TranslatePipe], template: "<button\n  class=\"cx-asm-customer-360-product-item-media link\"\n  [attr.aria-label]=\"product?.name\"\n  (click)=\"selectProduct.emit(product)\"\n>\n  <cx-media\n    [container]=\"product?.images?.PRIMARY\"\n    format=\"product\"\n    [alt]=\"product?.name ?? ''\"\n  ></cx-media>\n</button>\n<div class=\"cx-asm-customer-360-product-item-content\">\n  <button\n    [attr.aria-label]=\"product?.name\"\n    (click)=\"selectProduct.emit(product)\"\n    class=\"cx-asm-customer-360-product-item-name link\"\n  >\n    <span title=\"{{ product?.name }}\">{{ product?.name }}</span>\n  </button>\n  <ng-container *ngIf=\"isOrderEntry; else notOrderEntryTemplate\">\n    <div class=\"cx-asm-customer-360-product-item-code\">\n      {{ product?.code }}\n    </div>\n    <div class=\"cx-asm-customer-360-product-item-quantity\" *ngIf=\"quantity\">\n      {{\n        'asmCustomer360.productItem.quantity' | cxTranslate: { count: quantity }\n      }}\n    </div>\n    <div class=\"cx-asm-customer-360-product-item-price\">\n      {{\n        'asmCustomer360.productItem.itemPrice'\n          | cxTranslate\n            : { price: product?.basePrice ?? product?.price?.formattedValue }\n      }}\n    </div>\n  </ng-container>\n  <ng-template #notOrderEntryTemplate>\n    <div\n      class=\"cx-asm-customer-360-product-item-out-of-stock\"\n      *ngIf=\"product.stock?.stockLevelStatus === 'outOfStock'\"\n    >\n      {{ 'asmCustomer360.productItem.outOfStock' | cxTranslate }}\n    </div>\n  </ng-template>\n</div>\n" }]
...
class AsmCustomer360ProductItemModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemModule, imports: [CommonModule,
            MediaModule,
            I18nModule,
            AsmCustomer360ProductItemComponent], exports: [AsmCustomer360ProductItemComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemModule, imports: [CommonModule,
            MediaModule,
            I18nModule,
            AsmCustomer360ProductItemComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductItemModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductListingComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i3.BreakpointService }], propDecorators: { emptyResultDescription: [{
                type: Input
            }], headerInactive: [{
                type: Input
            }], headerText: [{
...
class AsmCustomer360ProductListingModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductListingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductListingModule, imports: [CommonModule,
            I18nModule,
            MediaModule,
            AsmCustomer360ProductItemModule,
            AsmCustomer360ProductListingComponent], exports: [AsmCustomer360ProductListingComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductListingModule, imports: [CommonModule,
            I18nModule,
            MediaModule,
            AsmCustomer360ProductItemModule,
            AsmCustomer360ProductListingComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductListingModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360ActiveCartComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartComponent, deps: [{ token: AsmCustomer360SectionContext }, { token: i3$1.ProductService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360ActiveCartComponent, isStandalone: true, selector: "cx-asm-customer-360-active-cart", ngImport: i0, template: "<cx-asm-customer-360-product-listing\n  *ngIf=\"productItems$ | async as productItems\"\n  [emptyResultDescription]=\"\n    'asmCustomer360.activeCart.emptyDescription' | cxTranslate\n  \"\n  [headerInactive]=\"true\"\n  [headerTemplate]=\"headerTemplate\"\n  [headerText]=\"'asmCustomer360.activeCart.header' | cxTranslate\"\n  [products]=\"productItems\"\n  (selectProduct)=\"\n    sectionContext.navigate$.next({ cxRoute: 'product', params: $event })\n  \"\n>\n</cx-asm-customer-360-product-listing>\n\n<ng-template #headerTemplate>\n  <ng-container *ngIf=\"activeCart$ | async as activeCart\">\n    <button\n      [attr.aria-label]=\"\n        'asmCustomer360.activeCart.aria.linkLabel'\n          | cxTranslate: { code: activeCart.code }\n      \"\n      class=\"cx-overview-title-link link\"\n      (click)=\"sectionContext.navigate$.next({ cxRoute: 'cart' })\"\n    >\n      {{ activeCart.code }}\n    </button>\n    <div class=\"cart-total-no-items\">\n      {{\n        'asmCustomer360.productListing.totalNoItems'\n          | cxTranslate: { count: activeCart.totalItemCount }\n      }}\n    </div>\n    <div class=\"cart-divider\"></div>\n    <div class=\"cart-total-price\">\n      {{\n        'asmCustomer360.productListing.totalPrice'\n          | cxTranslate: { price: activeCart.totalPrice }\n      }}\n    </div>\n  </ng-container>\n</ng-template>\n", dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: AsmCustomer360ProductListingComponent, selector: "cx-asm-customer-360-product-listing", inputs: ["emptyResultDescription", "headerInactive", "headerText", "products", "headerTemplate"], outputs: ["clickHeader", "selectProduct"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-active-cart', imports: [
                        NgIf,
                        AsmCustomer360ProductListingComponent,
                        AsyncPipe,
                        TranslatePipe,
                    ], template: "<cx-asm-customer-360-product-listing\n  *ngIf=\"productItems$ | async as productItems\"\n  [emptyResultDescription]=\"\n    'asmCustomer360.activeCart.emptyDescription' | cxTranslate\n  \"\n  [headerInactive]=\"true\"\n  [headerTemplate]=\"headerTemplate\"\n  [headerText]=\"'asmCustomer360.activeCart.header' | cxTranslate\"\n  [products]=\"productItems\"\n  (selectProduct)=\"\n    sectionContext.navigate$.next({ cxRoute: 'product', params: $event })\n  \"\n>\n</cx-asm-customer-360-product-listing>\n\n<ng-template #headerTemplate>\n  <ng-container *ngIf=\"activeCart$ | async as activeCart\">\n    <button\n      [attr.aria-label]=\"\n        'asmCustomer360.activeCart.aria.linkLabel'\n          | cxTranslate: { code: activeCart.code }\n      \"\n      class=\"cx-overview-title-link link\"\n      (click)=\"sectionContext.navigate$.next({ cxRoute: 'cart' })\"\n    >\n      {{ activeCart.code }}\n    </button>\n    <div class=\"cart-total-no-items\">\n      {{\n        'asmCustomer360.productListing.totalNoItems'\n          | cxTranslate: { count: activeCart.totalItemCount }\n      }}\n    </div>\n    <div class=\"cart-divider\"></div>\n    <div class=\"cart-total-price\">\n      {{\n        'asmCustomer360.productListing.totalPrice'\n          | cxTranslate: { price: activeCart.totalPrice }\n      }}\n    </div>\n  </ng-container>\n</ng-template>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContext }, { type: i3$1.ProductService }] });
...
class AsmCustomer360ActiveCartModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360ActiveCartComponent], exports: [AsmCustomer360ActiveCartComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360ActiveCartComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActiveCartModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360TableComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AsmCustomer360Config }, { type: i3.DirectionService }], propDecorators: { table: [{
                type: ViewChild,
                args: ['table']
            }], columns: [{
                type: Input
...
class AsmCustomer360TableModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360TableModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360TableModule, imports: [CommonModule,
            I18nModule,
            ArgsModule,
            StarRatingModule,
            AsmCustomer360TableComponent], exports: [AsmCustomer360TableComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360TableModule, imports: [CommonModule,
            I18nModule,
            ArgsModule,
            StarRatingModule,
            AsmCustomer360TableComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360TableModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360ActivityComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityComponent, deps: [{ token: AsmCustomer360SectionContext }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360ActivityComponent, isStandalone: true, selector: "cx-asm-customer-360-activity", ngImport: i0, template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"'asmCustomer360.activity.emptyStateText' | cxTranslate\"\n  [headerText]=\"'asmCustomer360.activity.headerText' | cxTranslate\"\n  sortProperty=\"createdAt\"\n  [columns]=\"columns\"\n  [entries]=\"entries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"itemSelected($event)\"\n></cx-asm-customer-360-table>\n", dependencies: [{ kind: "component", type: AsmCustomer360TableComponent, selector: "cx-asm-customer-360-table", inputs: ["columns", "emptyStateText", "entries", "headerText", "pageSize", "sortProperty"], outputs: ["selectItem"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-activity', imports: [AsmCustomer360TableComponent, AsyncPipe, TranslatePipe], template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"'asmCustomer360.activity.emptyStateText' | cxTranslate\"\n  [headerText]=\"'asmCustomer360.activity.headerText' | cxTranslate\"\n  sortProperty=\"createdAt\"\n  [columns]=\"columns\"\n  [entries]=\"entries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"itemSelected($event)\"\n></cx-asm-customer-360-table>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContext }] });
...
class AsmCustomer360ActivityModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360ActivityComponent], exports: [AsmCustomer360ActivityComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360ActivityComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ActivityModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360PromotionListingModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionListingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionListingModule, imports: [CommonModule,
            I18nModule,
            ArgsModule,
            StarRatingModule,
            MessageComponentModule,
            IconModule,
            AsmCustomer360PromotionListingComponent], exports: [AsmCustomer360PromotionListingComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionListingModule, imports: [CommonModule,
            I18nModule,
            ArgsModule,
            StarRatingModule,
            MessageComponentModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionListingModule, decorators: [{
            type: NgModule,
            args: [{
...
class AsmCustomer360CouponComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CouponComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CouponComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            AsmCustomer360CouponComponent], exports: [AsmCustomer360CouponComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CouponComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            AsmCustomer360CouponComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CouponComponentModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360CustomerCouponComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CustomerCouponComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CustomerCouponComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            IconModule,
            SearchBoxModule,
            AsmCustomer360CustomerCouponComponent], exports: [AsmCustomer360CustomerCouponComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CustomerCouponComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            IconModule,
            SearchBoxModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360CustomerCouponComponentModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360MapComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360MapComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360MapComponentModule, imports: [CommonModule, I18nModule, AsmCustomer360MapComponent], exports: [AsmCustomer360MapComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360MapComponentModule, imports: [CommonModule, I18nModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360MapComponentModule, decorators: [{
            type: NgModule,
            args: [{
...
class AsmCustomer360ProductInterestsComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsComponent, deps: [{ token: AsmCustomer360SectionContext }, { token: i3$1.ProductService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360ProductInterestsComponent, isStandalone: true, selector: "cx-asm-customer-360-product-interests", ngImport: i0, template: "<cx-asm-customer-360-product-listing\n  *ngIf=\"products$ | async as products\"\n  [emptyResultDescription]=\"\n    'asmCustomer360.productInterests.emptyDescription' | cxTranslate\n  \"\n  [headerText]=\"'asmCustomer360.productInterests.header' | cxTranslate\"\n  [products]=\"products\"\n  (clickHeader)=\"sectionContext.navigate$.next({ cxRoute: 'myInterests' })\"\n  (selectProduct)=\"\n    sectionContext.navigate$.next({ cxRoute: 'product', params: $event })\n  \"\n>\n</cx-asm-customer-360-product-listing>\n", dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: AsmCustomer360ProductListingComponent, selector: "cx-asm-customer-360-product-listing", inputs: ["emptyResultDescription", "headerInactive", "headerText", "products", "headerTemplate"], outputs: ["clickHeader", "selectProduct"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-product-interests', imports: [
                        NgIf,
                        AsmCustomer360ProductListingComponent,
                        AsyncPipe,
                        TranslatePipe,
...
class AsmCustomer360ProductInterestsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360ProductInterestsComponent], exports: [AsmCustomer360ProductInterestsComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360ProductInterestsComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductInterestsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360ProductReviewsComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponent, deps: [{ token: AsmCustomer360Config }, { token: AsmCustomer360SectionContext }, { token: i3$1.CxDatePipe }, { token: i3$1.TranslationService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360ProductReviewsComponent, isStandalone: true, selector: "cx-asm-customer-360-product-reviews", providers: [CxDatePipe], ngImport: i0, template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"\n    'asmCustomer360.productReviews.emptyDescription' | cxTranslate\n  \"\n  [headerText]=\"'asmCustomer360.productReviews.header' | cxTranslate\"\n  sortProperty=\"dateAndStatus\"\n  [columns]=\"reviewColumns\"\n  [entries]=\"reviewEntries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"navigateTo($event)\"\n></cx-asm-customer-360-table>\n", dependencies: [{ kind: "component", type: AsmCustomer360TableComponent, selector: "cx-asm-customer-360-table", inputs: ["columns", "emptyStateText", "entries", "headerText", "pageSize", "sortProperty"], outputs: ["selectItem"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-product-reviews', providers: [CxDatePipe], imports: [AsmCustomer360TableComponent, AsyncPipe, TranslatePipe], template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"\n    'asmCustomer360.productReviews.emptyDescription' | cxTranslate\n  \"\n  [headerText]=\"'asmCustomer360.productReviews.header' | cxTranslate\"\n  sortProperty=\"dateAndStatus\"\n  [columns]=\"reviewColumns\"\n  [entries]=\"reviewEntries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"navigateTo($event)\"\n></cx-asm-customer-360-table>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360Config }, { type: AsmCustomer360SectionContext }, { type: i3$1.CxDatePipe }, { type: i3$1.TranslationService }] });
...
class AsmCustomer360ProductReviewsComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponentModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360ProductReviewsComponent], exports: [AsmCustomer360ProductReviewsComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponentModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360ProductReviewsComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProductReviewsComponentModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProfileComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContext }, { type: i3$1.TranslationService }] });
...
class AsmCustomer360ProfileModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProfileModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProfileModule, imports: [CardModule,
            CommonModule,
            I18nModule,
            AsmCustomer360ProfileComponent], exports: [AsmCustomer360ProfileComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProfileModule, imports: [CardModule,
            CommonModule,
            I18nModule,
            AsmCustomer360ProfileComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ProfileModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CardModule,
...
class AsmCustomer360PromotionComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponent, deps: [{ token: AsmCustomer360SectionContext }, { token: i2.AsmCustomer360Facade }, { token: i2$1.ActiveCartFacade }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360PromotionComponent, isStandalone: true, selector: "cx-asm-customer-360-promotion", ngImport: i0, template: "<cx-asm-customer-360-promotion-listing\n  [emptyStateText]=\"'asmCustomer360.promotions.emptyDescription' | cxTranslate\"\n  [headerText]=\"'asmCustomer360.promotions.headerText' | cxTranslate\"\n  [showAlert]=\"showErrorAlert$ | async\"\n  [entries]=\"entries$ | async\"\n  [applied]=\"'asmCustomer360.promotions.applied' | cxTranslate\"\n  [showRemoveButton]=\"false\"\n  [showApplyButton]=\"false\"\n>\n</cx-asm-customer-360-promotion-listing>\n", dependencies: [{ kind: "component", type: AsmCustomer360PromotionListingComponent, selector: "cx-asm-customer-360-promotion-listing", inputs: ["headerText", "emptyStateText", "applyButtonText", "applied", "removeButtonText", "entries", "showAlert", "showAlertForApplyAction", "showRemoveButton", "showApplyButton", "isCustomerCoupon"], outputs: ["apply", "remove", "removeAlert", "removeAlertForApplyAction"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-promotion', imports: [AsmCustomer360PromotionListingComponent, AsyncPipe, TranslatePipe], template: "<cx-asm-customer-360-promotion-listing\n  [emptyStateText]=\"'asmCustomer360.promotions.emptyDescription' | cxTranslate\"\n  [headerText]=\"'asmCustomer360.promotions.headerText' | cxTranslate\"\n  [showAlert]=\"showErrorAlert$ | async\"\n  [entries]=\"entries$ | async\"\n  [applied]=\"'asmCustomer360.promotions.applied' | cxTranslate\"\n  [showRemoveButton]=\"false\"\n  [showApplyButton]=\"false\"\n>\n</cx-asm-customer-360-promotion-listing>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContext }, { type: i2.AsmCustomer360Facade }, { type: i2$1.ActiveCartFacade }] });
...
class AsmCustomer360PromotionComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            AsmCustomer360PromotionComponent], exports: [AsmCustomer360PromotionComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponentModule, imports: [CommonModule,
            AsmCustomer360PromotionListingModule,
            I18nModule,
            AsmCustomer360PromotionComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360PromotionComponentModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360SavedCartComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartComponent, deps: [{ token: AsmCustomer360SectionContext }, { token: i3$1.ProductService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360SavedCartComponent, isStandalone: true, selector: "cx-asm-customer-360-saved-cart", ngImport: i0, template: "<cx-asm-customer-360-product-listing\n  *ngIf=\"productItems$ | async as productItems\"\n  [emptyResultDescription]=\"\n    'asmCustomer360.savedCart.emptyDescription' | cxTranslate\n  \"\n  [headerInactive]=\"true\"\n  [headerTemplate]=\"headerTemplate\"\n  [headerText]=\"'asmCustomer360.savedCart.header' | cxTranslate\"\n  [products]=\"productItems\"\n  (selectProduct)=\"\n    sectionContext.navigate$.next({ cxRoute: 'product', params: $event })\n  \"\n>\n</cx-asm-customer-360-product-listing>\n\n<ng-template #headerTemplate>\n  <ng-container *ngIf=\"savedCart$ | async as savedCart\">\n    <button\n      [attr.aria-label]=\"\n        'asmCustomer360.savedCart.aria.linkLabel'\n          | cxTranslate: { code: savedCart.code }\n      \"\n      class=\"cx-overview-title-link link\"\n      (click)=\"\n        sectionContext.navigate$.next({\n          cxRoute: 'savedCartsDetails',\n          params: { savedCartId: savedCart?.code },\n        })\n      \"\n    >\n      {{ savedCart.code }}\n    </button>\n    <div class=\"cart-total-no-items\">\n      {{\n        'asmCustomer360.productListing.totalNoItems'\n          | cxTranslate: { count: savedCart.totalItemCount }\n      }}\n    </div>\n    <div class=\"cart-divider\"></div>\n    <div class=\"cart-total-price\">\n      {{\n        'asmCustomer360.productListing.totalPrice'\n          | cxTranslate: { price: savedCart.totalPrice }\n      }}\n    </div>\n  </ng-container>\n</ng-template>\n", dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: AsmCustomer360ProductListingComponent, selector: "cx-asm-customer-360-product-listing", inputs: ["emptyResultDescription", "headerInactive", "headerText", "products", "headerTemplate"], outputs: ["clickHeader", "selectProduct"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-asm-customer-360-saved-cart', changeDetection: ChangeDetectionStrategy.OnPush, imports: [
                        NgIf,
                        AsmCustomer360ProductListingComponent,
                        AsyncPipe,
                        TranslatePipe,
...
class AsmCustomer360SavedCartModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360SavedCartComponent], exports: [AsmCustomer360SavedCartComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartModule, imports: [CommonModule,
            I18nModule,
            AsmCustomer360ProductListingModule,
            AsmCustomer360SavedCartComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SavedCartModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360SupportTicketsComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponent, deps: [{ token: AsmCustomer360SectionContext }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: AsmCustomer360SupportTicketsComponent, isStandalone: true, selector: "cx-asm-customer-360-support-tickets", ngImport: i0, template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"\n    'asmCustomer360.supportTickets.emptyDescription' | cxTranslate\n  \"\n  [headerText]=\"'asmCustomer360.supportTickets.header' | cxTranslate\"\n  sortProperty=\"createdAt\"\n  [columns]=\"supportTicketsColumns\"\n  [entries]=\"supportTicketsEntries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"navigateTo($event)\"\n></cx-asm-customer-360-table>\n", dependencies: [{ kind: "component", type: AsmCustomer360TableComponent, selector: "cx-asm-customer-360-table", inputs: ["columns", "emptyStateText", "entries", "headerText", "pageSize", "sortProperty"], outputs: ["selectItem"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponent, decorators: [{
            type: Component,
            args: [{ changeDetection: ChangeDetectionStrategy.OnPush, selector: 'cx-asm-customer-360-support-tickets', imports: [AsmCustomer360TableComponent, AsyncPipe, TranslatePipe], template: "<cx-asm-customer-360-table\n  [emptyStateText]=\"\n    'asmCustomer360.supportTickets.emptyDescription' | cxTranslate\n  \"\n  [headerText]=\"'asmCustomer360.supportTickets.header' | cxTranslate\"\n  sortProperty=\"createdAt\"\n  [columns]=\"supportTicketsColumns\"\n  [entries]=\"supportTicketsEntries$ | async\"\n  [pageSize]=\"(context.config$ | async)?.pageSize\"\n  (selectItem)=\"navigateTo($event)\"\n></cx-asm-customer-360-table>\n" }]
        }], ctorParameters: () => [{ type: AsmCustomer360SectionContext }] });
...
class AsmCustomer360SupportTicketsComponentModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponentModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponentModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360SupportTicketsComponent], exports: [AsmCustomer360SupportTicketsComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponentModule, imports: [CommonModule,
            AsmCustomer360TableModule,
            I18nModule,
            AsmCustomer360SupportTicketsComponent] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360SupportTicketsComponentModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class AsmCustomer360ComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ComponentsModule, imports: [CommonModule,
            StarRatingModule,
            I18nModule,
            ArgsModule,
            MediaModule,
            ...
            AsmCustomer360SectionComponent], exports: [AsmCustomer360Component] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ComponentsModule, providers: [provideDefaultConfig(defaultAsmCustomer360LayoutConfig)], imports: [CommonModule,
            StarRatingModule,
            I18nModule,
            ArgsModule,
            MediaModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: AsmCustomer360ComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
