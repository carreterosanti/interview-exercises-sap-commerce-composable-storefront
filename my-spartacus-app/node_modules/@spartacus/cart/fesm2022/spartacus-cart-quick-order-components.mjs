import { NgIf, AsyncPipe, CommonModule, NgFor, NgClass, KeyValuePipe } from '@angular/common';
import * as i0 from '@angular/core';
import { inject, ChangeDetectionStrategy, Component, NgModule, isDevMode, Injectable, ViewChild, Input } from '@angular/core';
import * as i3 from '@angular/forms';
import { Validators, FormsModule, ReactiveFormsModule, UntypedFormGroup, UntypedFormControl } from '@angular/forms';
import * as i1 from '@spartacus/cart/base/root';
import { CartAddEntrySuccessEvent, OrderEntriesSource, ProductImportStatus } from '@spartacus/cart/base/root';
import * as i2 from '@spartacus/core';
import { FeatureConfigService, GlobalMessageType, FeatureDirective, TranslatePipe, I18nModule, FeaturesConfigModule, provideDefaultConfig, LoggerService, UrlPipe, UrlModule } from '@spartacus/core';
import * as i2$1 from '@spartacus/storefront';
import { FormRequiredAsterisksComponent, FormErrorsComponent, FormErrorsModule, FormRequiredLegendComponent, ICON_TYPE, IconComponent, MediaComponent, ItemCounterComponent, MessageComponent, ProgressButtonComponent, AtMessageModule, IconModule, ItemCounterModule, MediaModule, MessageComponentModule, ProgressButtonModule } from '@spartacus/storefront';
...
class CartQuickOrderFormComponent {
    ...
    buildForm() {
        const useValidation = this.featureConfigService.isEnabled('a11yCartQuickOrderFormEnableSubmitAndAddValidation');
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormComponent, deps: [{ token: i1.ActiveCartFacade }, { token: i2.EventService }, { token: i3.UntypedFormBuilder }, { token: i2.GlobalMessageService }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: CartQuickOrderFormComponent, isStandalone: true, selector: "cx-cart-quick-order-form", ngImport: i0, template: "<ng-container *ngIf=\"cart$ | async as cart\">\n  <div class=\"cx-cart-quick-order-form-title\">\n    {{ 'quickOrderCartForm.title' | cxTranslate }}\n  </div>\n  <div class=\"form-group\">\n    <form (ngSubmit)=\"applyQuickOrder()\" [formGroup]=\"quickOrderForm\">\n      <div class=\"cx-cart-quick-order-form-container\">\n        <span class=\"cx-cart-quick-order-form-productID\">\n          <label class=\"cx-cart-quick-order-form-label\">\n            {{ 'quickOrderCartForm.productCodeLabel' | cxTranslate }}\n            <cx-form-required-asterisks />\n          </label>\n          <input\n            [attr.aria-invalid]=\"\n              quickOrderForm.get('productCode')?.touched &&\n              quickOrderForm.get('productCode')?.invalid\n            \"\n            [attr.aria-errormessage]=\"'productCodeError'\"\n            [attr.aria-label]=\"\n              'quickOrderCartForm.entryProductCode' | cxTranslate\n            \"\n            class=\"form-control input-product-code\"\n            formControlName=\"productCode\"\n            placeholder=\"{{\n              'quickOrderCartForm.productCodePlaceholder' | cxTranslate\n            }}\"\n            type=\"text\"\n          />\n        </span>\n        <span class=\"cx-cart-quick-order-form-qty\">\n          <label class=\"cx-cart-quick-order-form-label\">\n            {{ 'quickOrderCartForm.quantityFullLabel' | cxTranslate }}\n            <cx-form-required-asterisks />\n          </label>\n          <input\n            [attr.aria-label]=\"'quickOrderCartForm.quantity' | cxTranslate\"\n            class=\"form-control input-quantity\"\n            formControlName=\"quantity\"\n            type=\"number\"\n          />\n        </span>\n        <cx-form-errors\n          *cxFeature=\"'a11yCartQuickOrderFormEnableSubmitAndAddValidation'\"\n          id=\"productCodeError\"\n          [translationParams]=\"{\n            label: 'quickOrderCartForm.productCodeLabel' | cxTranslate,\n          }\"\n          [control]=\"quickOrderForm.get('productCode')\"\n        ></cx-form-errors>\n        <button\n          *cxFeature=\"'a11yCartQuickOrderFormEnableSubmitAndAddValidation'\"\n          [attr.aria-label]=\"'quickOrderCartForm.addToCart' | cxTranslate\"\n          [class.disabled]=\"cartIsLoading$ | async\"\n          [disabled]=\"cartIsLoading$ | async\"\n          class=\"btn btn-block btn-secondary apply-quick-order-button\"\n          type=\"submit\"\n        >\n          {{ 'quickOrderCartForm.add' | cxTranslate }}\n        </button>\n        <button\n          *cxFeature=\"'!a11yCartQuickOrderFormEnableSubmitAndAddValidation'\"\n          [attr.aria-label]=\"'quickOrderCartForm.addToCart' | cxTranslate\"\n          [class.disabled]=\"cartIsLoading$ | async\"\n          [disabled]=\"\n            (cartIsLoading$ | async) ||\n            !quickOrderForm.get('productCode')?.value ||\n            !quickOrderForm.get('quantity')?.value\n          \"\n          class=\"btn btn-block btn-secondary apply-quick-order-button\"\n          type=\"submit\"\n        >\n          {{ 'quickOrderCartForm.add' | cxTranslate }}\n        </button>\n      </div>\n    </form>\n  </div>\n</ng-container>\n", dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i3.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: i3.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i3.NumberValueAccessor, selector: "input[type=number][formControlName],input[type=number][formControl],input[type=number][ngModel]" }, { kind: "directive", type: i3.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i3.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],[formArray],form:not([ngNoForm]),[ngForm]" }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i3.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i3.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "component", type: FormRequiredAsterisksComponent, selector: "cx-form-required-asterisks", inputs: ["titleTranslation"] }, { kind: "directive", type: FeatureDirective, selector: "[cxFeature]", inputs: ["cxFeature"] }, { kind: "component", type: FormErrorsComponent, selector: "cx-form-errors", inputs: ["prefix", "fallbackPrefix", "translationParams", "control"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-cart-quick-order-form', changeDetection: ChangeDetectionStrategy.OnPush, imports: [
                        NgIf,
                        FormsModule,
                        ReactiveFormsModule,
        ...
        }], ctorParameters: () => [{ type: i1.ActiveCartFacade }, { type: i2.EventService }, { type: i3.UntypedFormBuilder }, { type: i2.GlobalMessageService }] });
...
class CartQuickOrderFormModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormModule, imports: [CommonModule,
            ReactiveFormsModule,
            I18nModule,
            FormErrorsModule,
            ...
            CartQuickOrderFormComponent], exports: [CartQuickOrderFormComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CartQuickOrderFormModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class QuickOrderOrderEntriesContext {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderOrderEntriesContext, deps: [{ token: i1$1.QuickOrderFacade }, { token: i2.ProductConnector }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderOrderEntriesContext, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderOrderEntriesContext, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
        }], ctorParameters: () => [{ type: i1$1.QuickOrderFacade }, { type: i2.ProductConnector }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderFormComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i2.Config }, { type: i0.ChangeDetectorRef }, { type: i1$1.QuickOrderFacade }, { type: i2.WindowRef }], propDecorators: { limit: [{
                type: Input
            }], quickOrderInput: [{
                type: ViewChild,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderItemComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i0.ChangeDetectorRef }, { type: i1$1.QuickOrderFacade }], propDecorators: { entry: [{
                type: Input,
                args: ['entry']
            }], index: [{
                type: Input
...
class QuickOrderTableComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderTableComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: QuickOrderTableComponent, isStandalone: true, selector: "cx-quick-order-table", inputs: { entries: "entries", loading: "loading" }, ngImport: i0, template: "<table\n  *ngIf=\"entries?.length > 0\"\n  class=\"cx-quick-order-table-wrapper\"\n  role=\"table\"\n>\n  <caption class=\"cx-visually-hidden\">\n    {{\n      'quickOrderTable.caption' | cxTranslate\n    }}\n  </caption>\n  <thead>\n    <tr role=\"row\" class=\"cx-item-list-header cx-quick-order-table-header\">\n      <th role=\"columnheader\" class=\"cx-item-list-desc\">\n        {{ 'quickOrderTable.product' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-price\">\n        {{ 'quickOrderTable.price' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-qty\">\n        {{ 'quickOrderTable.quantityFull' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-actions\">\n        {{ 'quickOrderTable.actions' | cxTranslate }}\n      </th>\n    </tr>\n  </thead>\n  <tbody class=\"cx-item-list-items\">\n    <tr\n      cx-quick-order-item\n      class=\"cx-item-list-row cx-quick-order-table-row\"\n      *ngFor=\"let entry of entries; let i = index\"\n      [entry]=\"entry\"\n      [index]=\"i\"\n      [loading]=\"loading\"\n    ></tr>\n  </tbody>\n</table>\n", dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "component", type: QuickOrderItemComponent, selector: "[cx-quick-order-item], cx-quick-order-item", inputs: ["entry", "index", "loading"] }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderTableComponent, decorators: [{
            type: Component,
            args: [{ selector: 'cx-quick-order-table', changeDetection: ChangeDetectionStrategy.OnPush, imports: [NgIf, NgFor, QuickOrderItemComponent, TranslatePipe], template: "<table\n  *ngIf=\"entries?.length > 0\"\n  class=\"cx-quick-order-table-wrapper\"\n  role=\"table\"\n>\n  <caption class=\"cx-visually-hidden\">\n    {{\n      'quickOrderTable.caption' | cxTranslate\n    }}\n  </caption>\n  <thead>\n    <tr role=\"row\" class=\"cx-item-list-header cx-quick-order-table-header\">\n      <th role=\"columnheader\" class=\"cx-item-list-desc\">\n        {{ 'quickOrderTable.product' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-price\">\n        {{ 'quickOrderTable.price' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-qty\">\n        {{ 'quickOrderTable.quantityFull' | cxTranslate }}\n      </th>\n      <th role=\"columnheader\" class=\"cx-item-list-actions\">\n        {{ 'quickOrderTable.actions' | cxTranslate }}\n      </th>\n    </tr>\n  </thead>\n  <tbody class=\"cx-item-list-items\">\n    <tr\n      cx-quick-order-item\n      class=\"cx-item-list-row cx-quick-order-table-row\"\n      *ngFor=\"let entry of entries; let i = index\"\n      [entry]=\"entry\"\n      [index]=\"i\"\n      [loading]=\"loading\"\n    ></tr>\n  </tbody>\n</table>\n" }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.ActiveCartFacade }, { type: i2$1.CmsComponentData }, { type: i2.GlobalMessageService }, { type: i1$1.QuickOrderFacade }, { type: i5.QuickOrderStatePersistenceService }], propDecorators: { quickOrderForm: [{
                type: ViewChild,
                args: ['quickOrderForm']
            }] } });
...
class QuickOrderListModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderListModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderListModule, imports: [AtMessageModule,
            CommonModule,
            FormErrorsModule,
            I18nModule,
            IconModule,
            ...
            QuickOrderTableComponent], exports: [QuickOrderComponent,
            QuickOrderFormComponent,
            QuickOrderItemComponent,
            QuickOrderTableComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderListModule, providers: [
            provideDefaultConfig({
                cmsComponents: {
                    QuickOrderComponent: {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderListModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        AtMessageModule,
...
class QuickOrderComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderComponentsModule, imports: [RouterModule, QuickOrderListModule, CartQuickOrderFormModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderComponentsModule, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: QuickOrderComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [RouterModule, QuickOrderListModule, CartQuickOrderFormModule],
                    providers: [
