...
import { facadeFactory, AuthGuard, provideDefaultConfigFactory, provideDefaultConfig } from '@spartacus/core';
import { LAUNCH_CALLER, PageLayoutComponent, CmsPageGuard } from '@spartacus/storefront';
...
class SaveCartEvent extends SavedCartEvent {
     ...
     * Event's type
     */
    static { this.type = 'SaveCartEvent'; }
}
class SaveCartSuccessEvent extends SavedCartEvent {
    /**
     * Event's type
     */
    static { this.type = 'SaveCartSuccessEvent'; }
}
...
class SavedCartFacade {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartFacade, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartFacade, providedIn: 'root', useFactory: () => facadeFactory({
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartFacade, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
...
class SavedCartRootModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartRootModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: SavedCartRootModule, imports: [i1.RouterModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartRootModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: SavedCartRootModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
