...
function buildSmartEditConfig(options) {
    return {
        providers: {
            ...
            content: "<".concat(constants_1.SMART_EDIT_CONFIG, ">{\n        smartEdit: {\n          storefrontPreviewRoute: '").concat(options.storefrontPreviewRoute ||
                'STOREFRONT_PREVIEW_ROUTE_PLACEHOLDER', "',\n          allowOrigin: '").concat(options.allowOrigin || 'ALLOWED_ORIGIN_PLACEHOLDER', "',\n        },}"),
        },
    };
}
