...
function getConfiguredDependencies(feature) {
    var _a;
    var featureConfig = schematics_config_mappings_1.featureSchematicConfigMapping.get(feature);
    if (!featureConfig) {
        throw new schematics_1.SchematicsException("No feature config found for ".concat(feature, "."));
    }
