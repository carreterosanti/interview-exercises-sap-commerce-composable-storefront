...
function appendHtmlElementToHead(host, htmlFilePath, elementHtml) {
    ...
    var endTagOffset = (_a = headTag.sourceCodeLocation.endTag) === null || _a === void 0 ? void 0 : _a.startOffset;
    if (!endTagOffset) {
        throw Error("Could not find end offset of '<head>' element in HTML file: ".concat(htmlFileBuffer));
    }
