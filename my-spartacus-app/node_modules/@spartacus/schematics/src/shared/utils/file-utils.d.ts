...
export declare function removeImport(source: ts.SourceFile, importToRemove: {
    className?: string;
    importPath: string;
}): Change;
export declare function removeImportUsingTsMorph(fileSource: import('ts-morph').SourceFile, { importPath, importName }: {
    importPath: string;
    importName: string;
}): void;
export declare function removeImportFromContent(updatedContent: string, importToRemove: {
    symbolName?: string;
    importPath: string;
}): string;
 ...
 */
export declare function parseTsFileContent(fileContent: string): ts.SourceFile;
export {};
