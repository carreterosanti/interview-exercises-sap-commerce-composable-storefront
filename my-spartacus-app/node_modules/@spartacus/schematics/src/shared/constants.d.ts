...
export declare const ANGULAR_SSR = "@angular/ssr";
...
/***** Imports end *****/
/***** File names start *****/
export declare const APP_MODULE = "app.module.ts";
export declare const ANGULAR_SERVER_MODULE = "app.module.server.ts";
export declare const APP_CONFIG = "app.config.ts";
export declare const APP_CONFIG_SERVER = "app.config.server.ts";
export declare const APP_COMPONENT = "app.component.ts";
export declare const APP_COMPONENT_HTML = "app.component.html";
export declare const APP_ROUTES_SERVER = "app.routes.server.ts";
export declare const INDEX_HTML = "index.html";
export declare const MAIN_TS = "main.ts";
export declare const SERVER_TS = "server.ts";
/***** File names end *****/
/***** Classes start *****/
...
export declare const KEY_VALUE_DIFFERS = "KeyValueDiffers";
...
export declare const PROVIDE_CONFIG_FACTORY_FUNCTION = "provideConfigFactory";
export declare const PROVIDE_FEATURE_TOGGLES_FUNCTION = "provideFeatureToggles";
export declare const PROVIDE_ZONE_CHANGE_DETECTION = "provideZoneChangeDetection";
...
export declare const FORM_ERRORS_COMPONENT = "FormErrorsComponent";
...
export declare const ACTIVE_CART_FACADE = "ActiveCartFacade";
...
export declare const UNIT_LEVEL_ORDER_HISTORY_COMPONENT = "UnitLevelOrderHistoryComponent";
...
export declare const ADDED_TO_CART_DIALOG_EVENT_LISTENER = "AddedToCartDialogEventListener";
...
export declare const LOGIN_GUARD = "LoginGuard";
...
export declare const REGISTER_COMPONENT_SERVICE = "RegisterComponentService";
...
export declare const PRODUCT_INTRO_COMPONENT = "ProductIntroComponent";
...
export declare const SUGGESTED_ADDRESS_DIALOG_COMPONENT = "SuggestedAddressDialogComponent";
...
export declare const INNER_COMPONENTS_HOST_DIRECTIVE = "InnerComponentsHostDirective";
...
export declare const PARAGRAPH_COMPONENT = "ParagraphComponent";
...
export declare const CART_EVENT_BUILDER = "CartEventBuilder";
export declare const REGISTER_DELETE_CART = "registerDeleteCart";
...
export declare const SAVED_CART_EVENT_BUILDER = "SavedCartEventBuilder";
export declare const REGISTER_DELETE_SAVED_CART_EVENTS = "registerDeleteSavedCartEvents";
...
export declare const CONFIGURATOR_EVENT_LISTENER = "RulebasedConfiguratorEventListener";
export declare const CONFIGURATOR_COMMONS_SERVICE = "ConfiguratorCommonsService";
export declare const CONFIGURATOR_REMOVE_OBSOLETE_PRODUCT_BOUND_CONFIGURATION = "removeObsoleteProductBoundConfiguration";
...
export declare const CONFIGURATOR_GROUP_TITLE_COMPONENT = "ConfiguratorGroupTitleComponent";
export declare const CONFIGURATOR_CONFIGURATION_OBS = "configuration$";
export declare const CONFIGURATOR_GROUP_MENU_COMPONENT = "ConfiguratorGroupMenuComponent";
export declare const CONFIGURATOR_TAB_BAR_COMPONENT = "ConfiguratorTabBarComponent";
...
export declare const CONFIGURATOR_ADD_TO_CART_BUTTON_COMPONENT = "ConfiguratorAddToCartButtonComponent";
export declare const CONFIGURATOR_CART_ENTRY_BUNDLE_INFO_COMPONENT = "ConfiguratorCartEntryBundleInfoComponent";
export declare const CONFIGURATOR_CART_ENTRY_BUNDLE_INFO_SERVICE = "ConfiguratorCartEntryBundleInfoService";
export declare const CONFIGURATOR_ATTRIBUTE_HEADER_COMPONENT = "ConfiguratorAttributeHeaderComponent";
export declare const CONFIGURATOR_ATTRIBUTE_MULTI_SELECTION_BUNDLE_COMPONENT = "ConfiguratorAttributeMultiSelectionBundleComponent";
export declare const CONFIGURATOR_ATTRIBUTE_SINGLE_SELECTION_BUNDLE_COMPONENT = "ConfiguratorAttributeSingleSelectionBundleComponent";
export declare const CONFIGURATOR_ATTRIBUTE_PRODUCT_CARD_COMPONENT = "ConfiguratorAttributeProductCardComponent";
export declare const CONFIGURATOR_OVERVIEW_BUNDLE_ATTRIBUTE_COMPONENT = "ConfiguratorOverviewBundleAttributeComponent";
export declare const OCC_CONFIGURATOR_VARIANT_NORMALIZER = "OccConfiguratorVariantNormalizer";
export declare const DIRECTION_SERVICE = "DirectionService";
export declare const QUICK_ORDER_SERVICE = "QuickOrderService";
export declare const PRODUCT_ADAPTER = "ProductAdapter";
export declare const PRODUCT_SEARCH_CONNECTOR = "ProductSearchConnector";
...
export declare const CMS_PAGE_GUARD = "CmsPageGuard";
export declare const REFRESH_IN_PROGRESS = "refreshInProgress";
export declare const HANDLE_EXPIRED_TOKEN = "handleExpiredToken";
export declare const SEARCH = "search";
export declare const REMOVE_ENTRY = "removeEntry";
export declare const QUICK_ORDER_FORM_COMPONENT = "QuickOrderFormComponent";
export declare const QUICK_ORDER_FACADE = "QuickOrderFacade";
export declare const PROGRESS_BUTTON_COMPONENT = "ProgressButtonComponent";
export declare const REINITALIZE_MENU = "reinitalizeMenu";
export declare const PAGE_LAYOUT_HANDLER = "PageLayoutHandler";
export declare const BAD_REQUEST_HANDLER = "BadRequestHandler";
export declare const BAD_VOUCHER_REQUEST_HANDLER = "BadVoucherRequestHandler";
export declare const FACET_SERVICE = "FacetService";
export declare const PROFILE_TAG_EVENT_SERVICE = "ProfileTagEventService";
export declare const PROFILE_TAG_LIFECYCLE_SERVICE = "ProfileTagLifecycleService";
export declare const CDS_MERCHANDISING_PRODUCT_SERVICE = "CdsMerchandisingProductService";
export declare const MERCHANDISING_STRATEGY_CONNECTOR = "MerchandisingStrategyConnector";
export declare const CDS_MERCHANDISING_USER_CONTEXT_SERVICE = "CdsMerchandisingUserContextService";
export declare const CDS_MERCHANDISING_SITE_CONTEXT_SERVICE = "CdsMerchandisingSiteContextService";
export declare const CDS_MERCHANDISING_SEARCH_CONTEXT_SERVICE = "CdsMerchandisingSearchContextService";
export declare const CDS_MERCHANDISING_FACET_NORMALIZER = "MerchandisingFacetNormalizer";
export declare const CDS_MERCHANDISING_FACET_TO_QUERY_PARAM_NORMALIZER = "MerchandisingFacetToQueryparamNormalizer";
export declare const LOAD_PRODUCT_FOR_STRATEGY_METHOD = "loadProductsForStrategy";
export declare const CONSIGNMENT_TRACKING_COMPONENT = "ConsignmentTrackingComponent";
export declare const TRACKING_EVENTS_COMPONENT = "TrackingEventsComponent";
export declare const ORDER_HISTORY_FACADE = "OrderHistoryFacade";
export declare const NGB_ACTIVE_MODAL = "NgbActiveModal";
export declare const COUPON_CARD_COMPONENT = "CouponCardComponent";
export declare const COUPON_DIALOG_COMPONENT = "CouponDialogComponent";
export declare const MY_COUPONS_COMPONENT_SERVICE = "MyCouponsComponentService";
export declare const STOCK_NOTIFICATION_MODULE = "StockNotificationtModule";
export declare const STOCK_NOTIFICATION_DIALOG_COMPONENT = "StockNotificationDialogComponent";
export declare const SANITIZE_METHOD = "sanitize";
/***** Classes end *****/
...
export declare const ORDER_FACADE = "OrderFacade";
...
export declare const MODAL_OPTIONS = "ModalOptions";
export declare const MODAL_REF = "ModalRef";
export declare const MODAL_DIRECTIVE_OPTIONS = "ModalDirectiveOptions";
export declare const MODAL_DIRECTIVE_SERVICE = "ModalDirectiveService";
export declare const MODAL_DIRECTIVE = "ModalDirective";
export declare const MODAL_MODULE = "ModalModule";
...
export declare const LOCATION$ = "location$";
export declare const CLIK_EVENT = "clikEvent";
export declare const CLICK_EVENT = "clickEvent";
/***** Properties end *****/
/***** APIs start *****/
...
export declare const HANDLE_VOUCHER_OPERATION_ERROR = "handleVoucherOperationError";
...
export declare const EXTRACT_PRODUCT_CARD_PARAMETERS = "extractProductCardParameters";
export declare const CONFIGURATOR_API_IS_ATTRIBUTE_GROUP = "isAttributeGroup";
export declare const CONFIGURATOR_API_GET_CONFLICT_MESSAGE_KEY = "getConflictMessageKey";
export declare const CONFIGURATOR_CONVERT_ATTRIBUTE_TYPE = "convertAttributeType";
export declare const CONFIGURATOR_IS_IN_VIEWPORT = "isInViewport";
export declare const REPORT_AUTH_GUARD = "reportAuthGuard";
export declare const SAVE_CURRENT_NAVIGATION_URL = "saveCurrentNavigationUrl";
export declare const REPORT_NOT_AUTH_GUARD = "reportNotAuthGuard";
/***** APIs end *****/
/***** feature keys start *****/
...
export declare const CSS_V5_DOCS_URL = "https://sap.github.io/spartacus-docs/css-changes-in-version-5/";
export declare const CSS_V6_DOCS_URL = "https://help.sap.com/docs/SAP_COMMERCE_COMPOSABLE_STOREFRONT";
export declare const BANNER_COMPONENT = "BannerComponent";
export declare const GENERIC_LINK_COMPONENT = "GenericLinkComponent";
export declare const GENERIC_LINK_COMPONENT_SERVICE = "GenericLinkComponentService";
export declare const CDC_JS_SERVICE = "CdcJsService";
export declare const SERVER_FILENAME = "server.ts";
export declare const SERVER_BAK_FILENAME = "server.ts.bak";
export declare const OLD_ZONE_IMPORT = "zone.js/dist/zone-node";
export declare const NEW_ZONE_IMPORT = "zone.js/node";
export declare const NGUNIVERSAL_IMPORT = "@nguniversal/express-engine";
export declare const SSR_SETUP_IMPORT = "@spartacus/setup/ssr";
export declare const EXPRESS_TOKENS = "express.tokens";
export declare const APP_ROUTING_MODULE = "AppRoutingModule";
export declare const APP_ROUTING_MODULE_LOCAL_PATH = "./app-routing.module";
export declare const APP_ROUTING_MODULE_LOCAL_FILENAME = "app-routing.module.ts";
export declare const BROWSER_MODULE = "BrowserModule";
export declare const FEATURE_TOGGLES_COPIED_FROM_CORE_LIB_PATH = "../feature-toggles.copied-from-core-lib";
