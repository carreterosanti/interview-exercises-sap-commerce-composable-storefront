import { AsyncPipe, CommonModule, NgFor, NgIf, TitleCasePipe, KeyValuePipe } from '@angular/common';
import * as i0 from '@angular/core';
import { Injectable, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
import { LogoutEvent, LoginEvent, UrlPipe, TranslatePipe, UrlModule, I18nModule, provideDefaultConfig } from '@spartacus/core';
import * as i1$1 from '@spartacus/order/root';
import { recurrencePeriod, DaysOfWeek, ORDER_TYPE } from '@spartacus/order/root';
import * as i4 from '@spartacus/storefront';
import { LAUNCH_CALLER, AtMessageDirective, AtMessageModule, ICON_TYPE, IconComponent, IconModule } from '@spartacus/storefront';
...
class CheckoutReplenishmentFormService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutReplenishmentFormService, deps: [{ token: i1.EventService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutReplenishmentFormService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutReplenishmentFormService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class CheckoutScheduledReplenishmentPlaceOrderComponent extends CheckoutPlaceOrderComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderComponent, deps: [{ token: i1$1.OrderFacade }, { token: i1.RoutingService }, { token: i3.UntypedFormBuilder }, { token: i4.LaunchDialogService }, { token: i0.ViewContainerRef }, { token: CheckoutReplenishmentFormService }, { token: i1$1.ScheduledReplenishmentOrderFacade }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.9", type: CheckoutScheduledReplenishmentPlaceOrderComponent, isStandalone: true, selector: "cx-place-order", usesInheritance: true, ngImport: i0, template: "<form class=\"cx-place-order-form form-check\" [formGroup]=\"checkoutSubmitForm\">\n  <div class=\"form-group\">\n    <label>\n      <input\n        formControlName=\"termsAndConditions\"\n        class=\"scaled-input form-check-input\"\n        type=\"checkbox\"\n      />\n      <span class=\"form-check-label\">\n        {{ 'checkoutReview.confirmThatRead' | cxTranslate }}\n        <a\n          [routerLink]=\"{ cxRoute: 'termsAndConditions' } | cxUrl\"\n          class=\"cx-tc-link\"\n          target=\"_blank\"\n          rel=\"noopener noreferrer\"\n        >\n          {{ 'checkoutReview.termsAndConditions' | cxTranslate }}\n        </a>\n      </span>\n    </label>\n  </div>\n\n  <button\n    (click)=\"submitForm()\"\n    class=\"btn btn-primary btn-block\"\n    [disabled]=\"termsAndConditionInvalid || (daysOfWeekNotChecked$ | async)\"\n    [cxAtMessage]=\"'checkoutReview.orderInProcess' | cxTranslate\"\n  >\n    {{ 'checkoutReview.placeOrder' | cxTranslate }}\n  </button>\n</form>\n", dependencies: [{ kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i3.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: i3.CheckboxControlValueAccessor, selector: "input[type=checkbox][formControlName],input[type=checkbox][formControl],input[type=checkbox][ngModel]" }, { kind: "directive", type: i3.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i3.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],[formArray],form:not([ngNoForm]),[ngForm]" }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i3.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i3.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "directive", type: RouterLink, selector: "[routerLink]", inputs: ["target", "queryParams", "fragment", "queryParamsHandling", "state", "info", "relativeTo", "preserveFragment", "skipLocationChange", "replaceUrl", "routerLink"] }, { kind: "directive", type: AtMessageDirective, selector: "[cxAtMessage]", inputs: ["cxAtMessage"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "pipe", type: UrlPipe, name: "cxUrl" }, { kind: "pipe", type: TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderComponent, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [{ type: i1$1.OrderFacade }, { type: i1.RoutingService }, { type: i3.UntypedFormBuilder }, { type: i4.LaunchDialogService }, { type: i0.ViewContainerRef }, { type: CheckoutReplenishmentFormService }, { type: i1$1.ScheduledReplenishmentOrderFacade }] });
...
class CheckoutScheduledReplenishmentPlaceOrderModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, imports: [AtMessageModule,
            CommonModule,
            RouterModule,
            UrlModule,
            I18nModule,
            ReactiveFormsModule,
            CheckoutScheduledReplenishmentPlaceOrderComponent], exports: [CheckoutScheduledReplenishmentPlaceOrderComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentPlaceOrderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        AtMessageModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduleReplenishmentOrderComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: CheckoutReplenishmentFormService }] });
...
class CheckoutScheduleReplenishmentOrderModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, imports: [CommonModule,
            RouterModule,
            I18nModule,
            IconModule,
            CheckoutScheduleReplenishmentOrderComponent], exports: [CheckoutScheduleReplenishmentOrderComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, providers: [
            provideDefaultConfig({
                cmsComponents: {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduleReplenishmentOrderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
class CheckoutScheduledReplenishmentComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, imports: [CommonModule,
            CheckoutScheduleReplenishmentOrderModule,
            CheckoutScheduledReplenishmentPlaceOrderModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, imports: [CommonModule,
            CheckoutScheduleReplenishmentOrderModule,
            CheckoutScheduledReplenishmentPlaceOrderModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CheckoutScheduledReplenishmentComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
