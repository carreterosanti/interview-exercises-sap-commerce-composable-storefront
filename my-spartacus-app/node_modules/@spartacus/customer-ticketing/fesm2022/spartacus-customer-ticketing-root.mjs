...
import { Config, CxEvent, GlobalMessageType, LanguageSetEvent, CurrencySetEvent, LogoutEvent, LoginEvent, AuthGuard, provideDefaultConfigFactory, provideDefaultConfig, facadeFactory } from '@spartacus/core';
import * as i1$1 from '@angular/router';
import { RouterModule } from '@angular/router';
import { PageLayoutComponent, CmsPageGuard, LAUNCH_CALLER } from '@spartacus/storefront';
...
class CustomerTicketingConfig {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConfig, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConfig, providedIn: 'root', useExisting: Config }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConfig, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                    useExisting: Config,
...
class CustomerTicketingEventListener {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventListener, deps: [{ token: i1.EventService }, { token: i1.GlobalMessageService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventListener, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventListener, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class CustomerTicketingEventModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventModule, deps: [{ token: CustomerTicketingEventListener }], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventModule }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingEventModule, decorators: [{
            type: NgModule,
            args: [{}]
        }], ctorParameters: () => [{ type: CustomerTicketingEventListener }] });
...
class CustomerTicketingRootModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingRootModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingRootModule, imports: [CustomerTicketingEventModule, i1$1.RouterModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingRootModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingRootModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
...
class CustomerTicketingFacade {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingFacade, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingFacade, providedIn: 'root', useFactory: () => facadeFactory({
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingFacade, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
...
LAUNCH_CALLER['CUSTOMER_TICKETING_CLOSE'] = 'CUSTOMER_TICKETING_CLOSE';
...
(function (TEXT_COLOR_CLASS) {
    TEXT_COLOR_CLASS["GREY"] = "cx-text-grey";
    TEXT_COLOR_CLASS["GREEN"] = "cx-text-green";
...
(function (STATUS_NAME) {
    STATUS_NAME["OPEN"] = "Open";
    STATUS_NAME["CLOSED"] = "Closed";
    STATUS_NAME["INPROCESS"] = "INPROCESS";
