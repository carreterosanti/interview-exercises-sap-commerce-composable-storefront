...
import { CommandStrategy, OccHttpErrorReason, OccHttpErrorType, HttpErrorHandler, HttpResponseStatus, Priority, getLastValueSync, GlobalMessageType, PageMetaResolver, PageType } from '@spartacus/core';
import * as i3 from '@spartacus/customer-ticketing/root';
import { GetTicketCategoryQueryReloadEvent, GetTicketCategoryQueryResetEvent, GetTicketAssociatedObjectsQueryReloadEvent, GetTicketAssociatedObjectsQueryResetEvent, GetTicketQueryReloadEvent, GetTicketQueryResetEvent, GetTicketsQueryReloadEvents, GetTicketsQueryResetEvents, TicketCreatedEvent, STATUS, TicketClosedEvent, TicketReopenedEvent, NewMessageEvent, UploadAttachmentSuccessEvent, CustomerTicketingFacade } from '@spartacus/customer-ticketing/root';
...
class CustomerTicketingConnector {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConnector, deps: [{ token: CustomerTicketingAdapter }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConnector }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingConnector, decorators: [{
            type: Injectable
        }], ctorParameters: () => [{ type: CustomerTicketingAdapter }] });
...
class CustomerTicketingService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingService, deps: [{ token: i1.QueryService }, { token: i1.CommandService }, { token: i1.UserIdService }, { token: CustomerTicketingConnector }, { token: i1.RoutingService }, { token: i1.EventService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [{ type: i1.QueryService }, { type: i1.CommandService }, { type: i1.UserIdService }, { type: CustomerTicketingConnector }, { type: i1.RoutingService }, { type: i1.EventService }] });
...
function isNotFoundError(error) {
    return (error.reason === OccHttpErrorReason.NOT_FOUND_ERROR &&
...
class NotFoundTicketRequestHandler extends HttpErrorHandler {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: NotFoundTicketRequestHandler, deps: [{ token: i1.GlobalMessageService }, { token: i1.RoutingService }, { token: PLATFORM_ID }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: NotFoundTicketRequestHandler, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: NotFoundTicketRequestHandler, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
        }], ctorParameters: () => [{ type: i1.GlobalMessageService }, { type: i1.RoutingService }, { type: Object, decorators: [{
                    type: Inject,
                    args: [PLATFORM_ID]
                }] }] });
...
class CustomerTicketingPageMetaResolver extends PageMetaResolver {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingPageMetaResolver, deps: [{ token: i1.TranslationService }, { token: i2.ActiveCartFacade }, { token: i1.BasePageMetaResolver }, { token: i3.CustomerTicketingFacade }, { token: i1.TranslationService }, { token: i1.SemanticPathService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingPageMetaResolver, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingPageMetaResolver, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
        }], ctorParameters: () => [{ type: i1.TranslationService }, { type: i2.ActiveCartFacade }, { type: i1.BasePageMetaResolver }, { type: i3.CustomerTicketingFacade }, { type: i1.TranslationService }, { type: i1.SemanticPathService }] });
...
class CustomerTicketingCoreModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingCoreModule }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingCoreModule, providers: [
            ...facadeProviders,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: CustomerTicketingCoreModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        ...facadeProviders,
