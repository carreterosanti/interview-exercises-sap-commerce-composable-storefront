...
import { GlobalMessageType, TranslatePipe, CxDatePipe, I18nModule, UrlModule, FeaturesConfigModule, provideDefaultConfig, AuthGuard } from '@spartacus/core';
import * as i1 from '@spartacus/pdf-invoices/root';
import { InvoicesFields } from '@spartacus/pdf-invoices/root';
import * as i3 from '@spartacus/storefront';
import { ICON_TYPE, SortingComponent, PaginationComponent, IconComponent, DatePickerModule, ListNavigationModule, IconModule, MediaModule, SpinnerModule } from '@spartacus/storefront';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: InvoicesListComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.PDFInvoicesFacade }, { type: i2.TranslationService }, { type: i3.FileDownloadService }, { type: i2.LanguageService }, { type: i2.GlobalMessageService }] });
...
class PDFInvoicesComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: PDFInvoicesComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.9", ngImport: i0, type: PDFInvoicesComponentsModule, imports: [CommonModule,
            DatePickerModule,
            I18nModule,
            ReactiveFormsModule,
            ...
            InvoicesListComponent], exports: [InvoicesListComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: PDFInvoicesComponentsModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.9", ngImport: i0, type: PDFInvoicesComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
